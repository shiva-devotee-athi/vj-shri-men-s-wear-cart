...
class Products {
      ...
      products.forEach(product => {
       ...
       <div class="product">
                  <div class="img-container">
                      <img src="https://res.cloudinary.com/deu93r3up/image/upload/v1667486191/Img/Img/${product.PIC}.jpg" alt="${product.NAME}" class="product-img" />
                  </div>
                    <h3>${product.NAME}</h3>
                    <h4>${product.SHOP}</h4>
  ...
  addCartItem(item) {
    ...
    div.innerHTML = `<!-- cart item -->
            <!-- item image -->
            <img src=https://res.cloudinary.com/deu93r3up/image/upload/v1667486191/Img/Img/${item.PIC}.jpg alt="product" />
            <!-- item info -->
            <div>
              <h4>${item.NAME}</h4>
              <h5>Rs.${item.AMT}</h5>
